{{-- famedo override of igniter-orange::includes.order.items (forked from ti-theme-orange v4.1.3) --}}
{{-- Single change: inclusive tax rows (code tax*) are RENDERED — upstream skips every
     non-summable row, which hides the "inkl. X% MwSt." lines on the order/success page. --}}
    ...
    <div class="table-responsive">
        <table class="table table-sm table-borderless mb-0">
            ...
            @foreach ($order->getOrderTotals() as $orderTotal)
                ...
                @continue(!$thickLine && !$orderTotal->is_summable && $orderTotal->code !== 'subtotal' && !str_starts_with((string)$orderTotal->code, 'tax'))
                <tr>
